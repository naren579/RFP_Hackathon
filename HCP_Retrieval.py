...
db3 = Chroma(persist_directory="/mount/src/RFP_Hackathon/VECTORS_HCP/", collection_name="netapp_embeddings",embedding_function=embedding_func)
...
store_netapp  = LocalFileStore(root_path="/mount/src/RFP_Hackathon/PARENT_DOCUMENTS_HCP/")
id_key = "doc_id"
